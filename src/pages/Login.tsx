      ...
      >
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-white/50 text-center leading-relaxed">
            Tantang lawan dari seluruh Indonesia.<br />Login untuk mulai bermain.
          </p>
        </div>
        ...
        <p className="text-xs text-white/30 text-center leading-relaxed">
          Dengan login kamu menyetujui syarat & ketentuan.<br />Data kamu aman dan tidak dijual ke pihak ketiga.
        </p>
      </div>
